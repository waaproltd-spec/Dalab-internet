...
/**
 * Referenced by AndroidManifest.xml (android:name=".SahalDataApp") but never
 ...
 *
 * "Sahal Data Agent keeps stopping" was reported repeatedly with no stack trace to
 ...
 *    usable from a report like "Sahal Data Agent keeps stopping" with a photo of
 ...
 */
class SahalDataApp : Application() {
