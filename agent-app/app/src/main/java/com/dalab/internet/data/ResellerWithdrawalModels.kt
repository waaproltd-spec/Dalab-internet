...
data class ResellerWithdrawalPendingPayout(
    ...
    val createdAt: String,      // the withdrawal's real creation time -- used only to order this request against a concurrent request for the same SIM slot in UssdSimLock, see ResellerWithdrawalInteractiveUssdOrchestrator
