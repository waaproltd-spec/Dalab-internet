# SAHAL DATA — Backend API

A real, running, tested Node.js backend for the SAHAL DATA system — not a mock,
not a plan. It implements every endpoint in `sahal-data-backend-architecture.md` and is
...
- One demo admin: `admin@sahaldata.so` / `ChangeMe123!`
...
See `sahal-data-backend-architecture.md` §4 for the full list this implements — customer
