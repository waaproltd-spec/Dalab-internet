...
companiesRouter.post("/admin/companies", requireStaff(), async (req, res) => {
...
companiesRouter.put("/admin/companies/:id", requireStaff(), async (req, res) => {
...
companiesRouter.put("/admin/companies/:id/payment-number", requireStaff(), async (req, res) => {
...
companiesRouter.put("/admin/companies/:id/status", requireStaff(), async (req, res) => {
...
packagesRouter.post("/admin/packages", requireStaff(), async (req, res) => {
...
packagesRouter.put("/admin/packages/:id", requireStaff(), async (req, res) => {
...
packagesRouter.delete("/admin/packages/:id", requireStaff(), async (req, res) => {
