...
// Static privacy policy page for the SAHAL DATA Customer App, required
...
<title>Privacy Policy — SAHAL DATA</title>
<style>
...
<body>
<h1>Privacy Policy — SAHAL DATA</h1>
<p class="updated">Last updated: 2026-07-31</p>

<p>This Privacy Policy explains how the SAHAL DATA Customer App ("the App"), provided by WAAPROLTD, collects, uses, stores, and protects information when you use it to purchase and manage internet/data packages.</p>
...
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<title>Delete Your Account — SAHAL DATA</title>
<style>
  body { font-family: system-ui, -apple-system, Segoe UI, Roboto, sans-serif; max-width: 720px; margin: 0 auto; padding: 32px 20px 80px; line-height: 1.6; color: #1a1a2e; }
  h1 { font-size: 1.6rem; }
  h2 { font-size: 1.15rem; margin-top: 2em; }
...
<body>
<h1>Delete Your Account — SAHAL DATA</h1>

<h2>Option 1: Delete in the app (immediate)</h2>
<p>Open the SAHAL DATA app, go to <strong>Profile → Delete Account</strong>, and confirm. Your account is deleted immediately and permanently — this cannot be undone.</p>
...
async function start() {
  ...
  app.listen(PORT, () => {
    // eslint-disable-next-line no-console
    console.log(`SAHAL DATA Admin API listening on port ${PORT}`);
  });
}
